...
pub fn emulate_instruction(
    ...
    match ins.mnemonic() {
        ...
        Mnemonic::Nop => {
            emu.show_instruction(color!("LightPurple"), ins);
        }
        ...
        Mnemonic::Clc => {
            emu.show_instruction(color!("LightGray"), ins);
            emu.flags.f_cf = false;
        }
        ...
        Mnemonic::Fadd => {
            ...
            if ins.op_count() == 2 {
                ...
                if ins.op_kind(0) == iced_x86::OpKind::Memory {
                    ...
                    let mem_addr = emu.get_operand_value(ins, 0, false).expect("Fadd bad mem addr");
